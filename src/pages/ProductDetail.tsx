        ...
        <>
          <div style={{display: 'flex', flexDirection: 'row', alignItems:'flex-start', justifyContent:'flex-start', marginTop:'60px'}}>
            ...
            <div style={{marginLeft:'60px', marginTop:'60px'}}>
              ...
              <div style={{ fontFamily: 'arial', fontSize: '20px', marginTop:'25px', height:'100px' }}>{product.description}</div>
              <div style={{ fontFamily: 'arial', fontSize: '40px', fontWeight: 'bold' }}>{product.price}€</div>
              
              <div style={{marginTop:'20px'}}>
                <span onClick={()=> setCount(count+1)} style={{ fontSize: '50px',fontWeight:'bold', cursor:'pointer', marginRight:'25px'}}>+</span>
                <span style={{ fontSize: '40px', fontFamily: 'arial' }}>{count}</span>
                <span onClick={()=> setCount(count-1)} style={{ fontSize: '50px',fontWeight:'bold', cursor:'pointer', marginLeft:'25px'}}>-</span>
              </div>

              <div>
                <Button color="info" variant="contained" size="medium" sx={{textTransform:'none', marginTop:'20px'}}>  Add Cart  </Button>
              </div>
